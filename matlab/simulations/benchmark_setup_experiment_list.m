...
% make experimentlist
ex.NN = 30;  % Number of experiments
ex.m = 30;   % Number of microphones
ex.n = 30;   % Number of sounds
ex.outlier_ratio = 0.05; % Percentage of outlier measurements
% Each sound has 3 measurements, so this
% means that the chance that at least one of
% the measurements is wrong is 1-(1-outlier_ratio)^3
ex.missing_ratio = 0.05; % Percentage of missing measurements
